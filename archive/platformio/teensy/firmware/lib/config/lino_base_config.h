...
#define MAX_RPM 312               // motor's maximum RPM --> 5202 yellow jacket = 312 RMP max 75% is 234
#define COUNTS_PER_REV 537.7 //2150.4       // wheel encoder's no of ticks per rev --> PPR*4 = 537.6 * 4 = 2150.4
#define WHEEL_DIAMETER 0.121       // wheel's diameter in meters
#define PWM_BITS 8                // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.34  // distance between left and right wheels
#define FR_WHEELS_DISTANCE 0.27   // distance between front and rear wheels. Ignore this if you're on 2WD/ACKERMANN
...
//MOTOR PINS
#ifdef USE_Cytron_MDD10A
  #define DRIVER_Mode PWM_DIR
